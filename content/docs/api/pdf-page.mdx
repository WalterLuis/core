...
For advanced graphics operations, PDFPage provides methods to emit raw operators and register resources. See [Low-Level Drawing](/docs/advanced/low-level-drawing) for detailed usage.
