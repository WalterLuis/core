...
describe("identityFilter", () => {
  ...
  it("should return data unchanged on decode", async () => {
    ...
    const result = identityFilter.decode(input);
  ...
  it("should return data unchanged on encode", async () => {
    ...
    const result = identityFilter.encode(input);
  ...
  it("should handle empty data", async () => {
    ...
    expect(identityFilter.decode(empty)).toBe(empty);
    expect(identityFilter.encode(empty)).toBe(empty);
  });
  ...
  it("should ignore params", async () => {
    ...
    const decoded = identityFilter.decode(data, undefined);
    const encoded = identityFilter.encode(data, undefined);
